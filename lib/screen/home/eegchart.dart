...
class EEG extends StatefulWidget {
  final String id;
  const EEG({super.key, required this.id});
  @override
  _EEGState createState() => _EEGState();
}

class _EEGState extends State<EEG> {
  Timer? _timer;
  ...
  Future<void> fetchData() async {
    ...
    final variableLabel = 'eeg${widget.id}';
